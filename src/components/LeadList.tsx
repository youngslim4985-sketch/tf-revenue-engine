          ...
          {filteredLeads.length === 0 ? (
            <div className="p-20 text-center space-y-4">
              <div className="w-16 h-16 bg-[#141414]/5 rounded-full flex items-center justify-center mx-auto">
                <Search size={24} className="text-[#141414]/20" />
              </div>
              <div>
                <p className="text-lg font-serif italic text-[#141414]">No leads found</p>
                <p className="text-xs font-mono text-[#141414]/40 uppercase tracking-widest">Try adjusting your search or add a new lead</p>
              </div>
            </div>
          ) : (
